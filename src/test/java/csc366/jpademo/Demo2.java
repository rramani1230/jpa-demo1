...
//
// 	   //
// 	   Store s1 = new Store(1, "123 Sunshine Way", "SLO County", 1, lm1);
// 	   entityManager.persist(s1);
// 	   Store s2 = new Store(2, "124 Sunshine Way", "SLO County", 2, lm2);
// 	   entityManager.persist(s2);
// 	   Store s3 = new Store(3, "125 Sunshine Way", "SLO County", 3, lm3);
// 	   entityManager.persist(s3);
// 	   Store s4 = new Store(4, "126 Sunshine Way", "SLO County", 4, lm4);
// 	   entityManager.persist(s4);
// 	   Store s5 = new Store(5, "127 Sunshine Way", "SLO County", 5, lm5);
// 	   entityManager.persist(s5);
// 	   Store s6 = new Store(6, "128 Sunshine Way", "SLO County", 6, lm6);
// 	   entityManager.persist(s6);
// 	   Store s7 = new Store(7, "129 Sunshine Way", "SLO County", 7, lm7);
// 	   entityManager.persist(s7);
// 	   Store s8 = new Store(8, "130 Sunshine Way", "SLO County", 8, lm8);
